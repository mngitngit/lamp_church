...
export default {
    ...
    methods: {
        ...
        open() {
            ...
            else if (this.registrations[0].registration_type === 'Member' && this.registrations[0].with_awta_card == 'lost' && this.enable_lamp_id_availment)
            ...
            this.$confirm(msg, 'You did it!', {
                ...
                if (this.registrations[0].registration_type === 'Member'&& (this.registrations[0].with_awta_card == 'none' || this.registrations[0].with_awta_card == 'lost') && this.enable_lamp_id_availment) {
