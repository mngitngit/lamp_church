<template>
    <div>
        ...
        <span class="content">
            <div class="m-0">
                <el-checkbox v-model="isAllowing"/>&nbsp;&nbsp;I authorize LAMP Church to collect, use, and retain the personal information in this form for the purpose of attending LAMP Church 38th Anniversary and in the pursuit of any legal interests of the church.
